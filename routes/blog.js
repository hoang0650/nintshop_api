...
const {getBlogs, getBlog, getRelated, getBlogWithPage, getAllBlogComments,createBlogComment, createRelyComment, createBlog, updateBlog, deleteBlog} = require('../controllers/blogs')
